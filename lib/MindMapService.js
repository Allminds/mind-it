...
MindMapService.prototype.updateDB = function(targetNode,sourceNode){

      Mindmaps.update({_id:sourceNode._id},{$push :{parent_ids: targetNode._id}});
      Mindmaps.update({_id:sourceNode._id},{$set : {position:targetNode.position}});
   //  Mindmaps.update({_id:targetNode._id},{$push: {children:sourceNode}});
 };
