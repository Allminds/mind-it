App.MindMapService = (function () {
    ...
    getUpdatedNodeName = function (id, $set) {
        ...
        if (isRoot) {
            if (!Boolean(name)) {
                return createUpdatedNodeName(App.Constants.DefaultNodeName);
            }
        ...
        return createUpdatedNodeName(name);
    };

    var createUpdatedNodeName = function (updatedNodeNameValue) {
        return {name: updatedNodeNameValue};
    };
