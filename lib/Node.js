...
App.Node.reposition = function(selectedNode, newParent, destSubTree, destIndex) {
  var dir = App.Node.getDirection(selectedNode),
      parent = selectedNode.parent,
      siblings = (App.Node.isRoot(parent) ? parent[dir] : parent.childSubTree) || [],
      selectedNodeIndex = siblings.indexOf(selectedNode),
      ...
      //repositionDoneFlag = false,
      destinationDirection = parent._id === newParent._id ? (dir == "right" ? "left" : "right"):(App.Node.isRoot(newParent) ? dir : "childSubTree"),
      destinationSubTree = destSubTree ? destSubTree : App.Node.isRoot(newParent) ? newParent[dir] : newParent.childSubTree,
      destinationIndex = destIndex ? destIndex : destinationSubTree.length;
